...
public class specialcase {
		public static void main(String[] args) {
			int age=21;
			float salary=40000.34f;
			double bankbalance = 5454.76;
			char sam='@';
			long address= 1234567336;
			String str="samssdgshjgffhfch";
	     ...
	     //long store larger value perform mathematical operation  
